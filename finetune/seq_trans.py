...
def run_a_pretrain_epoch(args, args_g, epoch, model_bert, model_grover, model_coca, data_loader,
    ...
    torch.save(model_coca.state_dict(), os.path.join(args.get('save_dir', './checkpoints'), f'model_coca{epoch}.pth'))
    torch.save(model_bert.state_dict(), os.path.join(args.get('save_dir', './checkpoints'), f'model_bert{epoch}.pth'))
    return total_loss
